...
const Map<AppTextKey, String> deTranslations = <AppTextKey, String>{
  ...
  AppTextKey.settingsDiagnosticsRestart: 'Neustart',
  AppTextKey.settingsDiagnosticsCheckUpdates: 'Nach Updates suchen',
  AppTextKey.settingsDiagnosticsUpdatesUnavailableTitle: 'Noch nicht verfügbar',
  AppTextKey.settingsDiagnosticsUpdatesUnavailableMessage:
      'Die Update-Prüfung ist noch nicht implementiert.',
  AppTextKey.settingsExitPasswordTitle: 'Passwort erforderlich',
  AppTextKey.settingsExitPasswordHint: 'Passwort',
  AppTextKey.settingsExitPasswordIncorrect: 'Falsches Passwort',
  AppTextKey.settingsExitPasswordConfirmAction: 'Bestätigen',
  AppTextKey.settingsExitPasswordCancelAction: 'Abbrechen',
  ...
  AppTextKey.mapsSearchSemantic: 'Ziel suchen',
  AppTextKey.mapsSearchClearSemantic: 'Suche löschen',
  AppTextKey.mapsNavigationModeSemantic: 'Navigationsmodus: Fahrtrichtung oben',
  AppTextKey.mapsNorthUpSemantic: 'Norden oben ausrichten',
  AppTextKey.mapsRouteCalculating: 'Route wird berechnet …',
  AppTextKey.mapsRoutingOffline: 'Navigation nicht erreichbar',
  AppTextKey.mapsNoRouteFound: 'Keine Route gefunden',
