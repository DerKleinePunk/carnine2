...
const Map<AppTextKey, String> trTranslations = <AppTextKey, String>{
  ...
  AppTextKey.mediaRepeatOffSemantic: 'Tekrar: kapalı',
  AppTextKey.mediaRepeatQueueSemantic: 'Tekrar: çalma listesi',
  AppTextKey.mediaRepeatTrackSemantic: 'Tekrar: geçerli parça',
  AppTextKey.mediaVolumeSemantic: 'Ses düzeyi yüzde {percent}',
  AppTextKey.mediaMuteSemantic: 'Sessize al',
  AppTextKey.mediaUnmuteSemantic: 'Sesi aç',
  AppTextKey.mediaAudioErrorBanner: 'Ses hatası oluştu',
  AppTextKey.mediaAudioDeviceChangedBanner: 'Ses çıkış cihazı değişti',
  ...
  AppTextKey.mapsSearchSemantic: 'Hedef ara',
  AppTextKey.mapsSearchClearSemantic: 'Aramayı temizle',
  AppTextKey.mapsNavigationModeSemantic: 'Navigasyon modu: gidiş yönü yukarıda',
  AppTextKey.mapsNorthUpSemantic: 'Kuzeyi yukarıya hizala',
  AppTextKey.mapsRouteCalculating: 'Rota hesaplanıyor …',
  AppTextKey.mapsRoutingOffline: 'Navigasyon kullanılamıyor',
  AppTextKey.mapsNoRouteFound: 'Rota bulunamadı',
