...
const Map<AppTextKey, String> plTranslations = <AppTextKey, String>{
  ...
  AppTextKey.mediaRepeatOffSemantic: 'Powtarzanie: wyłączone',
  AppTextKey.mediaRepeatQueueSemantic: 'Powtarzanie: playlista',
  AppTextKey.mediaRepeatTrackSemantic: 'Powtarzanie: bieżący utwór',
  AppTextKey.mediaVolumeSemantic: 'Głośność {percent} procent',
  AppTextKey.mediaMuteSemantic: 'Wycisz',
  AppTextKey.mediaUnmuteSemantic: 'Wyłącz wyciszenie',
  AppTextKey.mediaAudioErrorBanner: 'Wystąpił błąd audio',
  AppTextKey.mediaAudioDeviceChangedBanner:
      'Zmieniono urządzenie wyjścia audio',
  ...
  AppTextKey.settingsDiagnosticsRestart: 'Uruchom ponownie',
  AppTextKey.settingsDiagnosticsCheckUpdates: 'Sprawdź aktualizacje',
  AppTextKey.settingsDiagnosticsUpdatesUnavailableTitle: 'Jeszcze niedostępne',
  AppTextKey.settingsDiagnosticsUpdatesUnavailableMessage:
      'Sprawdzanie aktualizacji nie jest jeszcze zaimplementowane.',
  AppTextKey.settingsExitPasswordTitle: 'Wymagane hasło',
  AppTextKey.settingsExitPasswordHint: 'Hasło',
  AppTextKey.settingsExitPasswordIncorrect: 'Nieprawidłowe hasło',
  AppTextKey.settingsExitPasswordConfirmAction: 'Potwierdź',
  AppTextKey.settingsExitPasswordCancelAction: 'Anuluj',
  ...
  AppTextKey.keyboardDoneAction: 'Gotowe',
  AppTextKey.keyboardLettersLayerLabel: 'ABC',
  AppTextKey.keyboardLettersLayerSemantic: 'Przełącz na litery',
  AppTextKey.keyboardNumbersLayerLabel: '123',
  AppTextKey.keyboardNumbersLayerSemantic: 'Przełącz na cyfry i symbole',
  ...
  AppTextKey.mapsNoRouteFound: 'Nie znaleziono trasy',
