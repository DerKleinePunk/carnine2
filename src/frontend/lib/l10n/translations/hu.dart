...
const Map<AppTextKey, String> huTranslations = <AppTextKey, String>{
  ...
  AppTextKey.settingsDiagnosticsRestart: 'Újraindítás',
  AppTextKey.settingsDiagnosticsCheckUpdates: 'Frissítések keresése',
  AppTextKey.settingsDiagnosticsUpdatesUnavailableTitle: 'Még nem elérhető',
  AppTextKey.settingsDiagnosticsUpdatesUnavailableMessage:
      'A frissítéskeresés még nincs megvalósítva.',
  AppTextKey.settingsExitPasswordTitle: 'Jelszó szükséges',
  AppTextKey.settingsExitPasswordHint: 'Jelszó',
  AppTextKey.settingsExitPasswordIncorrect: 'Hibás jelszó',
  AppTextKey.settingsExitPasswordConfirmAction: 'Megerősítés',
  AppTextKey.settingsExitPasswordCancelAction: 'Mégse',
  ...
  AppTextKey.mapsSearchSemantic: 'Úti cél keresése',
  AppTextKey.mapsSearchClearSemantic: 'Keresés törlése',
  AppTextKey.mapsNavigationModeSemantic: 'Navigációs mód: menetirány felül',
  AppTextKey.mapsNorthUpSemantic: 'Észak felül',
  AppTextKey.mapsRouteCalculating: 'Útvonal számítása …',
  AppTextKey.mapsRoutingOffline: 'A navigáció nem érhető el',
  AppTextKey.mapsNoRouteFound: 'Nem található útvonal',
