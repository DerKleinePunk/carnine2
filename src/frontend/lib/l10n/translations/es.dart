...
const Map<AppTextKey, String> esTranslations = <AppTextKey, String>{
  ...
  AppTextKey.mediaRepeatOffSemantic: 'Repetición: desactivada',
  AppTextKey.mediaRepeatQueueSemantic: 'Repetición: playlist',
  AppTextKey.mediaRepeatTrackSemantic: 'Repetición: pista actual',
  AppTextKey.mediaVolumeSemantic: 'Volumen {percent} por ciento',
  AppTextKey.mediaMuteSemantic: 'Silenciar',
  AppTextKey.mediaUnmuteSemantic: 'Reactivar sonido',
  AppTextKey.mediaAudioErrorBanner: 'Se produjo un error de audio',
  AppTextKey.mediaAudioDeviceChangedBanner:
      'Dispositivo de salida de audio cambiado',
  ...
  AppTextKey.mapsArrivalTomorrowLabel: 'Llegada mañana',
  ...
  AppTextKey.mapsSearchSemantic: 'Buscar destino',
  AppTextKey.mapsSearchClearSemantic: 'Borrar búsqueda',
  AppTextKey.mapsNavigationModeSemantic: 'Modo navegación: dirección arriba',
  AppTextKey.mapsNorthUpSemantic: 'Orientar el norte arriba',
  AppTextKey.mapsRouteCalculating: 'Calculando ruta …',
  AppTextKey.mapsRoutingOffline: 'Navegación no disponible',
  AppTextKey.mapsNoRouteFound: 'No se encontró ninguna ruta',
  AppTextKey.mapsNoPosition: 'Sin posición GPS',
  AppTextKey.mapsRouteError: 'No se pudo calcular la ruta',
  AppTextKey.mapsSearchNoResults: 'Sin resultados',
  AppTextKey.mapsTypePlace: 'Lugar',
  AppTextKey.mapsTypeRegion: 'Región',
  AppTextKey.mapsTypePoi: 'PDI',
  AppTextKey.mapsTypePeak: 'Cima',
  AppTextKey.mapsTypeWater: 'Agua',
